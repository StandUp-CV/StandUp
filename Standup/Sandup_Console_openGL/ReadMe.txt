========================================================================
    KONSOLENANWENDUNG: Sandup_Console_openGL-Projektübersicht
========================================================================

Diese Sandup_Console_openGL-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre Sandup_Console_openGL-Anwendung besteht.


Sandup_Console_openGL.vcxproj
...
Sandup_Console_openGL.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen Sandup_Console_openGL.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
